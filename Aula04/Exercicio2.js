// Gere uma lista contendo o nome de todos os cantores e álbuns. A
...
const albunsTodos = albuns.map(function(valor) {
    const cantores = valor.cantor;
    const albuns = valor.nome;
    return `${albuns} : ${cantores}`
})
console.log(albunsTodos);