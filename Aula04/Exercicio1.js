//Gere uma lista de objetos com o nome e ano de todos os álbuns da
// Marisa Monte
...
const albunsMarisaMonte = albuns.filter(obj => obj.cantor === "Marisa monte").map(obj => ({
    nome: obj.nome, ano:obj.ano
}))
